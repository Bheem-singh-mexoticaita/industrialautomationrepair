...
<div class="wraper">
    <section class="inner_banner bg_style"
        style="background-image: url('<?php echo get_stylesheet_directory_uri( __FILE__);?>/assets/img/service-banner.jpg')">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-7">
                    <div class="about_text title_head">
                        ...
                        <p>We are committed to provide excellence service and quality that we advertised, which means we
                            have original factory test equipment, documentation, quality repair procedures, and OEM
                            parts inventory. We have highly trained technicians and you will received fast delivery,
                            reliable & knowledgeable communications. Call us and one of our representative will contact
                            you immediately. We are looking forward to serving you.</p>
                    </div>
                </div>
            </div>
        </div>
